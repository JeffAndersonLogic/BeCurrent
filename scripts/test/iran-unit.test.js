...
try { generatedPayload = payloadMatch ? JSON.parse(payloadMatch[1]) : null; } catch (_) { generatedPayload = null; }
...
check('generated browser video payload reproduces exactly from the canonical video module', generatedPayload && JSON.stringify(generatedPayload) === JSON.stringify(videos));
