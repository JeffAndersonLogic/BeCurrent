...
The live check confirms configured URLs respond. Always do one final student-Chromebook check for district filtering, authentication, captions, and YouTube restrictions.
